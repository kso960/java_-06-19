...
public class Day01_1 { // c s 클래스의 시작
        // object 클래스로부터 데이터 제공받음
	        // 모든 클래스는 object로부터 시작된다
	            // 100% 클래스 언어 == 100% 객체 지향 언어
    // { } 안에 포함된 코드 tab [들여쓰기]
	// main 메소드
	   // ctrl + 스페이스바 : 자동완성
	public static void main(String[] args) {  // m s
		...
		System.out.println("java");
			// System : 시스템 관련 [ 입출력 ] 클래스
				// . : 클래스내 멤버에 접근할 수 있는 연산자 [ 특수문자  + - * 등 ]
					// out : 출력 관련 스트림
		  				// println("출력내용") : 출력 메소드
							// ; : [일처리 명령] 코드 한줄의 끝
		// 예제 1:println (자동줄바꿈 포함)
			// 컴퓨터 기계어 : 0,1 [수]
			// " " 문자처리 : 키워드 [ 미리 만들어진 단어/ 문 ] 을 제외한 모든 문자
		...
		*/
		...
		System.out.println("유재석\t출석\t결석\t결석");
