...
public class Day07_1 { // c s
	...
	// 메모리 저장 방법
		...
		// 메모리 관리 방법
			// 1. 배열 : 동일한 자료형/클래스의 여러개 메모리 선언/관리
				// int[] 배열 = new int[30];
			// 2. 리스트 : 동일한 클래스의 여러개 메모리를 저장할 수 있는 객체
	...
	public static void main(String[] args) { // m s
		...
		try {// try 안에서 예외[오류] 발생시 => catch로 이동
		...
		try {
			...
			// 스트림의 이동단위 바이트 , 영문은 1바이트 한글은 2바이트
			byte[] 바이트 = new byte[1024]; // 1024개 바이트를 저장할 수 있는 배열: 1024바이트 => 1kbyte
